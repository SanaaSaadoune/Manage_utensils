...
public class App {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("La surface des assiettes est : " + assiettesRondes.calculSurfaceAssiettesRondes(conn) + assiettesCarrees.calculSurfaceAssiettesCarrees(conn)+"\n");
			...
			System.out.println("Le prix total des ustensiles est : " + cuilleres.PrixCuillieres(conn) + assiettesRondes.PrixAssiettesRondes(conn) + assiettesCarrees.PrixAssiettesCarrees(conn)+"\n");
